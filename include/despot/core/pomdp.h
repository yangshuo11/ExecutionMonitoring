...
protected:                             
	Belief* local_belief;        //user-defined for checking belief status
	//Belief* simulated_belief;    //simulated belief through simulated belief update

public:
	DSPOMDP();

	DSPOMDP(Belief* belief);  //user-defined initialization function
	...
	virtual void UpdateLocalBelief(Belief* belief) ; //user-defined function 

	virtual Belief* GetLocalBelief() const; // user-defined function
	...
	//virtual void PrintSimulatedBelief(const vector<double> probs, std::ostream& out = std::cout) const = 0;

	//virtual void PrintSimulatedBelief(const Belief& simulated_belief, 
	//	std::ostream& out = std::cout) const = 0;

	//virtual int UpdateBeliefStatus(const Belief& belief) const = 0; // user-defined function for checking belief status 
