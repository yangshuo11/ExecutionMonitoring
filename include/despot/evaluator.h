...
protected:
	...
	State* state_;
	Belief* belief_;// added by user, for belief display only, not for belief update 
	//Belief* local_belief_; // for checking belief status only
	int belief_status_; // denote the uncertain status of the current belief
	int step_;
...
public:
	...
	//int UpdateBeliefStatus(const Belief& belief); // user-defined function for checking belief status only
