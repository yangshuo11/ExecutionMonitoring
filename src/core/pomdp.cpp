...
DSPOMDP::DSPOMDP() {
	local_belief = NULL;
	//simulated_belief = NULL;
}

DSPOMDP::DSPOMDP(Belief* belief): //user-defined initialization function
	local_belief(belief){
	}
...
/*void DSPOMDP::UpdateLocalBelief(Belief* belief) const { 
	local_belief = belief;
}*/

void DSPOMDP::UpdateLocalBelief(Belief* belief) { //user-defined function for updating local belief
	if (belief != NULL) {
		local_belief = belief;
	}
}

Belief* DSPOMDP::GetLocalBelief() const { //user-defined function 
	return local_belief;
}

//Belief* DSPOMDP::GetSimulatedBelief() const { //user-defined function
//	return simulated_belief;
//}

//void DSPOMDP::SetSimulatedBelief(const vector<double> probs) const { // user-defined function
//}
